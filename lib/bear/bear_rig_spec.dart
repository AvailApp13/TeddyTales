...
abstract final class BearRigSpec {
  ...
  ///
  /// Это НЕ наш персонаж: сторонний интерактивный монстр со своей State Machine
  /// и своими входами. Наши входы в нём отсутствуют, и приложение честно
  /// сообщит об этом в дев-лог.
  ///
  ...
  /// умолчанию, привязка данных, рендер и реакция на касания.
