...
/// `idle_life` — дыхание всем телом, `emo_smile` — моргнул → улыбка с
/// румянцем → открыл глаза. Исходник и сборка — `docs/rive-bear.md`.
///
...
class _RiveBearTrialState extends State<RiveBearTrial>
  ...
  void _react(BearFace face) {
    _painter.play(face);
    // Скелет пересобран (26.09): у `emo_smile` пока только лицо, тело
    // подыгрывает позой из приложения, как у остальных выражений.
    _bodyFace = face;
    _body
