...
void main() {
  ...
  testWidgets('по всей подсвеченной рамке, а не только в середине', (
    ...
    // Ковёр 0.114–0.886 по ширине и 0.650–0.910 по высоте. Проверяем оба
    // угла, где его перекрывают места игрушек, и середину.
    for (final point in const [
      Offset(60, 560), // левый край, под местом игрушки слева
      Offset(200, 600), // середина
      Offset(340, 540), // правый верх, под углом и игрушкой справа
    ]) {
      final taps = await tapAt(
        tester,
        point,
