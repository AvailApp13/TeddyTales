...
В покое (s = 0 и ±1) должно быть 0. На лету блюдо может пройти по
мишке — заказчик 24.09: «это ничего страшного, только никаких масок»;
блюда лежат поверх мишки целиком. Числа пути печатаются для сведения.
