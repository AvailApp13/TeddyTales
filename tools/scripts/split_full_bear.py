...
# ось уха (D20): середина линии, по которой ухо уходит под капюшон, на 20 px под
# капюшоном. Кость уха — от оси к краю; положения ушей (D24) — tools/scripts/ear_states.py.
