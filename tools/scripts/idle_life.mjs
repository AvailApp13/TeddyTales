 ...
 *   уши (D20)    — без резких рывков: приподнимаются на каждом вдохе, одно
 *                  плавное движение правым ухом и «прислушивание» — оба уха
 *                  вверх до 18°, голова набок, взгляд в сторону.
...
const EAR_MOVES = [['right', 420, 500, 12]];
const EAR_BREATH = 4, EAR_BREATH_LAG = 10;                           // уши на вдохе, с запаздыванием
const BELLY = 4.5, ARMS = 1.3;                                         // вдох: живот +4.5 %, лапы 1.3°
const LISTEN = { from: 600, to: 760, ear: 14, head: 2.5 };              // прислушивание: уши вверх, голова набок
