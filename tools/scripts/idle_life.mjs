...
const TWITCH = [[196, 'left', -7], [455, 'right', -8], [520, 'left', 5]];          // [кадр, ухо, угол°]; − вниз, + вверх
const LISTEN = { from: 600, to: 760, ear: 9, head: 2.5 };              // прислушивание: уши вверх, голова набок
